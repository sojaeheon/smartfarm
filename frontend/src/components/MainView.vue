...
export default {
    data() {
        return {
            videoSrc: 'http://REDACTED_PUBLIC_HOST:9999/video_feed',
            actuators: [
    ...
    methods: {
        ...
        async controlLed(index){
            ...
            await axios.post(`http://REDACTED_PUBLIC_HOST:9999/led`, {
                status: status
            })
            .catch(error => {
        ...
        async controlDcfan(index){
            ...
            await axios.post(`http://REDACTED_PUBLIC_HOST:9999/dcfan`, {
                status: status
            })
            .catch(error => {
                console.error('There was a problem with the axios operation:', error);
