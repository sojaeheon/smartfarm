...
app = Flask(__name__)
app.secret_key = 'REDACTED_SECRET'
CORS(app)
...
# 액추에이터 서버의 엔드포인트들
ACTUATOR_URLS = {
    "led": "http://REDACTED_PUBLIC_HOST:9999/led",
    "dc_fan": "http://REDACTED_PUBLIC_HOST:9999/dc_fan",
    "water_supply": "http://REDACTED_PUBLIC_HOST:9999/water_supply",
    "water_drainage": "http://REDACTED_PUBLIC_HOST:9999/water_drainage"
}
